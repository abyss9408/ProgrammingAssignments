/*!************************************************************************
  ...
  \brief
  This source file contains definitions of functions allocate and dellocate
  that allocates/dellocates memory for a 3d array of ints
**************************************************************************/
/*
...
int*** allocate(int F, int R, int C) {
  // Allocate one contigous block for all ints
  int* elements = new int[F * R * C];

  // Allocate array of pointers to rows
  int** rows = new int*[F * R];
...
void deallocate( int *** ppp ) {
  // Get the pointer to the rows array
  int** rows = ppp[0];
  // Get the pointer to the elements array
  int* elements = rows[0];
