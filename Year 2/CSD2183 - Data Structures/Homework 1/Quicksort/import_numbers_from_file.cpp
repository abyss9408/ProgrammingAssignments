...
// This function reads integers in the file specified by the `filename`
// parameter and stores them in an integer vector. It
...
// a number out of range, an error message is printed to the standard error stream and an
// empty vector is returned.
vector<int> importNumbersFromFile(const string &filename) {
